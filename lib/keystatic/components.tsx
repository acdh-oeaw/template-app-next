	...
	return {
		Disclosure: wrapper({
			...
			ContentView(props) {
				...
				return (
					<DisclosurePreview title={value.title}>
						{/* @ts-expect-error `keystatic` expects `react` v18 types. */}
						{children}
					</DisclosurePreview>
				);
	...
	return {
		...
		GridItem: wrapper({
			...
			ContentView(props) {
				...
				return (
					<GridItemPreview alignment={value.alignment}>
						{/* @ts-expect-error `keystatic` expects `react` v18 types. */}
						{children}
					</GridItemPreview>
				);
	...
	return {
		LinkButton: wrapper({
			...
			ContentView(props) {
				...
				return (
					<LinkButtonPreview link={value.link}>
						{/* @ts-expect-error `keystatic` expects `react` v18 types. */}
						{children}
					</LinkButtonPreview>
				);
