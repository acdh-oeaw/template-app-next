...
export const createCallout = createComponent((_paths, _language) => {
	return {
		Callout: wrapper({
			label: "Callout",
...
export const createDisclosure = createComponent((_paths, _language) => {
	return {
		Disclosure: wrapper({
			label: "Disclosure",
...
export const createEmbed = createComponent((_paths, _language) => {
	return {
		Embed: wrapper({
			label: "Embed",
...
export const createFigure = createComponent((paths, _language) => {
	return {
		Figure: wrapper({
			label: "Figure",
...
export const createFootnote = createComponent((_paths, _language) => {
	return {
		Footnote: mark({
			label: "Footnote",
...
export const createGrid = createComponent((_paths, _language) => {
	return {
		Grid: repeating({
			label: "Grid",
...
export const createHeadingId = createComponent((_paths, _language) => {
	return {
		HeadingId: inline({
			label: "HeadingId",
...
export const createLink = createComponent((paths, language) => {
	return {
		Link: mark({
			label: "Link",
			icon: <LinkIcon />,
			schema: {
				link: createLinkSchema(paths.downloadPath, language),
			},
			tag: "a",
		}),
	};
...
export const createLinkButton = createComponent((paths, language) => {
	return {
		LinkButton: wrapper({
			label: "LinkButton",
...
export const createTableOfContents = createComponent((_paths, _language) => {
	return {
...
export const createTabs = createComponent((_paths, _language) => {
	return {
		Tabs: repeating({
			label: "Tabs",
...
export const createVideo = createComponent((_paths, _language) => {
	return {
		Video: wrapper({
			label: "Video",
