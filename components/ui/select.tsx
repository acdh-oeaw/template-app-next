...
export function SelectValue<T extends object>({
	className,
	...props
}: AriaSelectValueProps<T>): ReactNode {
	return (
		<AriaSelectValue
			className={(values) => {
				return cn(
...
export function SelectTrigger({ className, children, ...props }: AriaButtonProps): ReactNode {
	return (
		<AriaButton
			className={(values) => {
				return cn(
...
export function SelectPopover({ className, offset = 0, ...props }: AriaPopoverProps): ReactNode {
	return (
		<AriaPopover
			className={(values) => {
				return cn(
