...
export function TailwindIndicator(): ReactNode {
	...
	return (
		<div className="fixed bottom-1 left-1 z-10 grid size-8 place-content-center rounded-full bg-on-background p-2 font-mono text-xs font-medium text-background">
