...
import { verifyEmailAction } from "@/app/[locale]/auth/verify-email/_actions/verify-email-action";
...
export function EmailVerificationFormContent(props: EmailVerificationFormContentProps): ReactNode {
	const { codeLabel, verifyLabel } = props;

	const [state, action] = useFormState(verifyEmailAction, createInitialActionState({}));
