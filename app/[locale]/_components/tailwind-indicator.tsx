...
export function TailwindIndicator(): ReactNode {
	...
	return (
		<div className="fixed right-5 bottom-5 z-10 grid size-8 cursor-default place-content-center rounded-full bg-background-inverse font-mono text-tiny font-strong text-text-inverse-strong shadow-raised select-none">
