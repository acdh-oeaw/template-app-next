...
import { ColorSchemeSelectLoadingIndicator } from "@/app/_components/color-scheme-select-loading-indicator";

export const ColorSchemeSelect = dynamic(
	() => {
		return import("@/app/_components/color-scheme-select").then((module) => {
