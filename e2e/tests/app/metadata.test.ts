...
test.describe("should set page metadata", () => {
	...
	test("with en locale", async ({ page }) => {
		...
		await expect(page).toHaveTitle("ACDH-CH App");

		const metaDescription = page.locator('meta[name="description"]');
		await expect(metaDescription).toHaveAttribute("content", "ACDH-CH Application template");

		const ogTitle = page.locator('meta[property="og:title"]');
		await expect(ogTitle).toHaveAttribute("content", "ACDH-CH App");

		const ogDescription = page.locator('meta[property="og:description"]');
		await expect(ogDescription).toHaveAttribute("content", "ACDH-CH Application template");
